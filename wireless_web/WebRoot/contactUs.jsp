				...
				<TBODY>
					<TR>
						...
						<TD align=middle><FONT
							...
							style="FONT-SIZE: 13px; COLOR: #000000">&nbsp;|&nbsp;</FONT><A
							href="aboutUs.jsp" target=_self><FONT
	...
	<TBODY>
		<TR vAlign=top>
				...
				<TBODY>
					<TR>
						...
						<div class='cnt'><marquee
							...
							width=15> 欢迎您使用网上订餐系统，祝您用餐愉快！</marquee></div>
						&nbsp;&nbsp;</TD>
					</TR>
				</TBODY>
			</TABLE>
			...
			<table width="70%" border="0" >
				<tr>
					<td colspan="4"><h1>在线客服</h1></td>
				</tr>
				<tr>
					<td width="25%">QQ客服1号：</td>
					<td align="left" valign="top">1197413838</td>
				</tr>
				<tr>
					<td >QQ客服2号：</td>
					<td align="left" valign="top">1297414238</td>
				</tr>
				<tr>
					<td height="33">&nbsp;</td>
					<td>&nbsp;</td>
